...
--1️OP_Limpio es la clave primaria, garantizando que cada orden de producción (OP) sea única.
--2️Se crean dos claves foráneas (FOREIGN KEY):
--OP_Limpio conecta con ID_Limpio en ConCubo_2025.
--OP_Limpio conecta con ID_Limpio en ConArbol_2025.
--3️saccod1 se mantiene como VARCHAR(50) porque sus valores son muy heterogéneos (002, 002/2, GUILLO, etc.).
--4️Alto, Ancho, Alto_V y Ancho_V son INT, asegurando que sean valores numéricos enteros.
